...
typedef enum nodeType {
	...
	NT_COMPOUNDSTATEMENT, NT_IFSTATEMENT, NT_WHILESTATEMENT, NT_DOWHILESTATEMENT , NT_FORSTATEMENT, 
	NT_RETURNSTATEMENT,NT_BREAKSTATEMENT,NT_NULLSTATEMENT, NT_SELECTIONSTATEMENT ,
	...
	NT_EXPRESSION_UNARYPLUS, NT_EXPRESSION_UNARYMINUS, NT_EXPRESSION_POSTFIX_PLUS, NT_EXPRESSION_POSTFIX_MINUS,
	NT_EXPRESSION_ASSIGN, NT_EXPRESSION_AND,
	...
	NT_EXPRESSION_ARRAY ,NT_ARRAY_REF , NT_ARRAY, NT_ELEMS , NT_ELEM ,NT_SWITCH_STATEMENT , NT_CASE_OPTIONS , NT_DEFAULT_OPTION
} NodeType;
